...
LeaTTa 1.0.5 is a research release with a fixed list of checked claims. The release does not claim the
...
```bash
tar xzf leatta-1.0.5-linux-x86_64.tar.gz
cd leatta-1.0.5-linux-x86_64 && ./install.sh   # installs to ~/.local/bin
