...
Main exports: Hypercube.SortCode, Hypercube.SortExpr, Hypercube.Equation,
  ...
  Hypercube.SpatialHead.slotFamily,
  ...
  Presentation.hypercubeSlots
Open obligations: generate the typing rules and sort-level equations from these concrete modal and
  spatial slot families, then feed the resulting equations to this center checker.
-/
