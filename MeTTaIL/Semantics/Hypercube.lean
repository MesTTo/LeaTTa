...
Main exports: Hypercube.SortCode, Hypercube.SortExpr, Hypercube.Equation,
  ...
  Hypercube.SpatialHead.ruleSchemes,
  ...
  Presentation.hypercubeRuleSchemes
Open obligations: interpret these rule-scheme descriptors as full typing judgments, generate the
  sort-level equations from those judgments, then feed the resulting equations to this center checker.
-/
